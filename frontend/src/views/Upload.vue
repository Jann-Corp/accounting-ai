...
<template>
  <div class="max-w-2xl mx-auto space-y-8">
    <h1 class="text-4xl font-medium text-gray-900 tracking-tight" style="letter-spacing: -0.4px;">🤖 AI 识别记账</h1>

    <!-- Wallet selector (global for all records) -->
    <div v-if="walletStore.wallets.length > 0" class="bg-white rounded-2xl p-6 border border-gray-100">
      <label class="block text-sm font-medium text-gray-700 mb-2" style="letter-spacing: 0.16px;">默认账户（可单独修改）</label>
